...
const AdminSettings = () => {
  ...
  const handleSave = () => {
    saveMutation.mutate({
      ...
      whatsapp_link_step_1: waStep1,
      whatsapp_link_step_2: waStep2,
      whatsapp_link_step_3: waStep3,
      whatsapp_link_step_4: waStep4,
      whatsapp_link_step_5: waStep5,
      whatsapp_link_step_6: waStep6,
