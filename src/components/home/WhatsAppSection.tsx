...
<section className="bg-muted/50 py-16 text-center">
    <div className="max-w-lg mx-auto">
      {g("whatsapp_image_url", "") && (
        <img src={g("whatsapp_image_url", "")} alt="WhatsApp" className="w-full max-h-48 object-cover rounded-xl mb-6" />
      )}
      <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366]/10 text-[#25D366] mb-4">
        <MessageCircle className="h-7 w-7" />
      </div>
      <h2 className="font-bold mb-3 text-2xl">{g("whatsapp_title", "WhatsApp গ্রুপে যোগ দিন")}</h2>
